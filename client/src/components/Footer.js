...
const Footer = () => {
  return (
    ...
    <div className="container-footer-all">
        <h2 className="equipotrabajo">Síguenos y Conoce Nuestros Trabajos</h2>
        <div className="container-body">
            <div className="colum1">
                ...
                <p>
                    ...
                    Empresa dedicada a: <br />
                    Desarrollos Informáticos. <br /> Diseños Gráficos & Arquitectónicos. <br /> Venta de Tecnologías. <br />
                    Contamos con Profesionales éticos y valores, utilizando la tecnología como herramienta principal para desarrollar nuestros diferentes Proyectos de Trabajo.
                </p>
            </div>
            <div className="colum2">
                <h1>Redes Sociales</h1>
            ...
            <div className="colum3">
                ...
                <div className="row2">
                    <img src={house} alt="Address" />
                    <label>Bahía de Caráquez, <br />Manabí Ecuador.</label>
                </div>
                <div className="row2">
                    <img src={contact} alt="Contact" />
                    <label>+593-983-81-6795.</label>
                ...
                <div className="row2">
                    <img src={google} alt="Google" />
                    <label>sistems26@gmail.com</label>
                </div>
            </div>
        </div>
    </div>
